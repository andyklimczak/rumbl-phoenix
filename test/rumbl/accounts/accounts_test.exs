defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/2" do
    ...
    test "oes not accept long usernames" do
  ...
  describe "authenticate_by_email_and_pass/2" do
    ...
    test "returns not found error with no match user for email" do
      assert {:error, :notfound} = Accounts.authenticate_by_email_and_pass("bademail@localhost", @pass)
    end
  end
end
